...
export default function PlayerJournalView() {
  ...
  useEffect(() => {
    ...
    urlUpdateTimeoutRef.current = setTimeout(() => {
      ...
      if (filters.coachName) params.set("coachName", filters.coachName);
  ...
  // Debounce text input filters (coachName, areaWorkedOn)
  useEffect(() => {
  ...
  }, [filters.coachName, filters.areaWorkedOn]);
